...
      const targetRoute = isGoogle ? `${API_URL}/google` : `${API_URL}${endpoint}`;
...
        <p className="text-center text-gray-500 mb-6">{isLogin ? "Welcome back!" : "Create a new account"}</p>
...
          <span className="flex-shrink mx-4 text-gray-400 text-sm font-semibold uppercase">or</span>
          <div className="flex-grow border-t border-gray-300"></div>
        </div>
